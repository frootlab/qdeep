...
def main():
    ...
    class MainWindow(QtGui.QMainWindow):
        ...
        def createMdiChild(self, type):
            if type == ('script', 'editor'): child = scriptEditor()
            elif type == ('dataset', 'editor'): child = datasetEditor()
            elif type == ('model', 'editor'): child = modelEditor()
            elif type == ('network', 'editor'): child = networkEditor()
            elif type == ('system', 'editor'): child = systemEditor()
            else: return None
    ...
    class datasetEditor(QtGui.QTextEdit):
        sequenceNumber = 1

        def __init__(self):
            super(datasetEditor, self).__init__()
    ...
    class networkEditor(QtGui.QTextEdit):
        sequenceNumber = 1

        def __init__(self):
            super(networkEditor, self).__init__()
    ...
    class modelEditor(QtGui.QTextEdit):
        sequenceNumber = 1
    ...
    class systemEditor(QtGui.QTextEdit):
        sequenceNumber = 1
